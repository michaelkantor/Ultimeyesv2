	...
	layoutBox1: ["wm.Layout", {"horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top"}, {}, {
		internaluploadsessionfileLivePanel1: ["wm.LivePanel", {"horizontalAlign":"left","verticalAlign":"top"}, {}, {
			usernameFilterPanel: ["wm.Panel", {"height":"24px","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top","width":"100%"}, {}, {
				usernameFilter: ["wm.SelectMenu", {"allowNone":true,"caption":"Usernames","dataField":"username","dataValue":undefined,"displayField":"username","displayValue":"","width":"100%"}, {}, {
					binding: ["wm.Binding", {}, {}, {
						wire: ["wm.Wire", {"expression":undefined,"source":"getUsernamesSVar","targetProperty":"dataSet"}, {}]
					}]
				}],
				licenseFilter: ["wm.SelectMenu", {"allowNone":true,"caption":"Licenses","dataField":"license","dataValue":undefined,"displayField":"license","displayValue":"","width":"100%"}, {}, {
					binding: ["wm.Binding", {}, {}, {
		...
		logDetailsPage: ["wm.PageContainer", {"pageName":"LogUploadsDetailsPage","subpageEventlist":{},"subpageMethodlist":{},"subpageProplist":{"currentSessionFileVarDataSet":"currentSessionFileVar.dataSet"},"width":"793px"}, {}, {
			binding: ["wm.Binding", {}, {}, {
